...
[![GitHub contributors](https://img.shields.io/github/contributors/serverless-nextjs/serverless-next.js)](https://github.com/Unity-Billal-mesloub/serverless-next.js-new/graphs/contributors)
...
![Build Status](https://github.com/Unity-Billal-mesloub/serverless-next.js-new/workflows/CI/badge.svg)
![End-to-end Tests](https://github.com/Unity-Billal-mesloub/serverless-next.js-new/workflows/End-to-end%20Tests/badge.svg)
...
Please review [features](https://github.com/Unity-Billal-mesloub/serverless-next.js-new#features) for a list of currently supported features.
...
> :warning: This README reflects the latest changes on the `master` branch. It may or may not yet be published to the `latest` (stable) or `alpha` release in npm. Please go to [Releases](https://github.com/Unity-Billal-mesloub/serverless-next.js-new/releases), find the correct `@sls-next/serverless-component` version you are using, and open the README for that release for more accurate information. If a feature is listed in this README but not working, please first try upgrading to the most recent `alpha` release in npm.
...
This project is a better version of the [serverless plugin](https://github.com/Unity-Billal-mesloub/serverless-next.js-new/tree/main/packages/deprecated/serverless-plugin) which focuses on addressing core issues like [next 9 support](https://github.com/Unity-Billal-mesloub/serverless-next.js-new/issues/), [better development experience](https://github.com/Unity-Billal-mesloub/serverless-next.js-new/issues/), [the 200 CloudFormation resource limit](https://github.com/Unity-Billal-mesloub/serverless-next.js-new/issues/) and [performance](https://github.com/Unity-Billal-mesloub/serverless-next.js-new/issues/).
...
Note that some features may only be on the latest [alpha version](https://www.npmjs.com/package/@sls-next/serverless-component?activeTab=versions). If a feature is listed as supported but not working on the `latest` tag, it most likely is in the `alpha` tag. If you can, please help us test the latest alpha changes and [submit a bug report](https://github.com/Unity-Billal-mesloub/serverless-next.js-new/issues/new?assignees=&labels=&template=bug_report.md&title=) if you find any issues. Thank you!

Is there a feature that you want but is not yet supported? Please open a [new issue](https://github.com/Unity-Billal-mesloub/serverless-next.js-new/issues/new?assignees=&labels=&template=feature_request.md&title=) to let us know!
...
2.72.2. See https://github.com/Unity-Billal-mesloub/serverless-next.js-new/issues/
...
To specify your own CloudFront inputs, just add any [aws-cloudfront inputs](https://github.com/Unity-Billal-mesloub/serverless-next.js-new/tree/main/packages/serverless-components/aws-cloudfront#3-configure) under `cloudfront`:
...
This is particularly useful for caching any of your Next.js pages at CloudFront's edge locations. See [this](https://github.com/Unity-Billal-mesloub/serverless-next.js-new/tree/main/packages/serverless-components/nextjs-component/examples/app-with-custom-caching-config) for an example application with custom cache configuration.
You can also [update an existing cloudfront distribution](https://github.com/Unity-Billal-mesloub/serverless-next.js-new/tree/main/packages/serverless-components/aws-cloudfront#updating-an-existing-cloudfront-distribution) using custom cloudfront inputs.
...
This is likely either because of a Lambda@Edge code size issue (see above for potential solutions. Related [GitHub Issue](https://github.com/Unity-Billal-mesloub/serverless-next.js-new/issues/)) or if you have a slow network upload speed and/or are trying to deploy a large Lambda package.
...
#### Should I use the [serverless-plugin](https://github.com/Unity-Billal-mesloub/serverless-next.js-new/tree/main/packages/deprecated/serverless-plugin) or this component?
...
See `examples/dynamodb-crud` for an example Todo application that interacts with DynamoDB. You can find a full list of examples [here](https://github.com/Unity-Billal-mesloub/serverless-next.js-new/tree/main/packages/serverless-components/nextjs-component/examples)
...
Refer to the [README](https://github.com/Unity-Billal-mesloub/serverless-next.js-new/blob/main/packages/libs/lambda-at-edge/src/build/third-party/README.md) for more information and caveats.

## Reporting Issues

You can open a new issue [here](https://github.com/Unity-Billal-mesloub/serverless-next.js-new/issues). If posting a problem, please follow the [debugging wiki](https://github.com/Unity-Billal-mesloub/serverless-next.js-new/wiki/Debugging-Issues) first for some useful tips, and try to include as much information to reproduce the issue.

If you are reporting a security vulnerability, please follow the [security policy](https://github.com/Unity-Billal-mesloub/serverless-next.js-new/security/policy) instead.
